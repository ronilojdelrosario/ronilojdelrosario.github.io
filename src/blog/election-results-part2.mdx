...
import provincial from '../assets/post_data/provincial.json';
import SwarmPlot from '../components/SwarmPlot.astro';
...
## <u>Some interactive plots because why not</u>

<SwarmPlot data={provincial.data} columns={provincial.columns} x_col="Name" y_col="Percent of votes" x_vals={["AQUINO, BAM","PANGILINAN, KIKO"]} colorCat="Region" sizeCat="Vote Count" tooltip_cols={["Name", "Province", "Region", "Percent of votes", "Vote Count"]}/>

<SwarmPlot data={provincial.data} columns={provincial.columns} x_col="Name" y_col="Percent of votes" x_vals={["MARCOS, IMEE R.","VILLAR, CAMILLE"]} colorCat="Region" sizeCat="Vote Count" tooltip_cols={["Name", "Province", "Region", "Percent of votes", "Vote Count"]}/>

<SwarmPlot data={provincial.data} columns={provincial.columns} x_col="Name" y_col="Percent of votes" x_vals={["GO, BONG GO","DELA ROSA, BATO"]} colorCat="Region" sizeCat="Vote Count" tooltip_cols={["Name", "Province", "Region", "Percent of votes", "Vote Count"]}/>